/*******************************************************************************
* File Name: LCD_SPIM_SCB_SPI_BOOT.c
* Version 1.0
*
* Description:
...
/*******************************************************************************
* Function Name: LCD_SPIM_SCB_SpiCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: LCD_SPIM_SCB_SpiCyBtldrCommStop
********************************************************************************
*
* Summary:
*  This fucntion does nothing.
...
/*******************************************************************************
* Function Name: LCD_SPIM_SCB_SpiCyBtldrCommReset
********************************************************************************
*
* Summary:
*  This fucntion does nothing.
...
/*******************************************************************************
* Function Name: LCD_SPIM_SCB_SpiCyBtldrCommRead
********************************************************************************
*
* Summary:
*  This fucntion does nothing.
...
/*******************************************************************************
* Function Name: LCD_SPIM_SCB_SpiCyBtldrCommWrite
********************************************************************************
*
* Summary:
*  This fucntion does nothing.
...
#endif /* defined(CYDEV_BOOTLOADER_IO_COMP) && (LCD_SPIM_SCB_EZSPI_BTLDR_COMM_ENABLED) */
