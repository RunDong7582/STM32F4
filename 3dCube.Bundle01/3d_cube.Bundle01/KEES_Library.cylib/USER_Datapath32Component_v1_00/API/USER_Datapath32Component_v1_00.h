...
#define `$INSTANCE_NAME`_A0_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__A0_REG)
#define `$INSTANCE_NAME`_A0_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__A0_REG)

// A1 register and pointer definitions
#define `$INSTANCE_NAME`_A1_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__A1_REG)
#define `$INSTANCE_NAME`_A1_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__A1_REG)

// D0 register and pointer definitions
#define `$INSTANCE_NAME`_D0_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__D0_REG)
#define `$INSTANCE_NAME`_D0_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__D0_REG)

// D1 register and pointer definitions
#define `$INSTANCE_NAME`_D1_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__D1_REG)
#define `$INSTANCE_NAME`_D1_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__D1_REG)

// F0 register and pointer definitions
#define `$INSTANCE_NAME`_F0_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__F0_REG)
#define `$INSTANCE_NAME`_F0_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__F0_REG)

// F1 register and pointer definitions
#define `$INSTANCE_NAME`_F1_PTR			((reg32 *) `$INSTANCE_NAME`_datapath_u0__F1_REG)
#define `$INSTANCE_NAME`_F1_REG			(*(reg32 *) `$INSTANCE_NAME`_datapath_u0__F1_REG)
...
// AUX CTL register and pointer definitions
#define `$INSTANCE_NAME`_AUX_CTL_C_PTR	((reg8 *) `$INSTANCE_NAME`_datapath_u2__DP_AUX_CTL_REG)
#define `$INSTANCE_NAME`_AUX_CTL_C_REG	(*(reg8 *) `$INSTANCE_NAME`_datapath_u2__DP_AUX_CTL_REG)

// AUX CTL register and pointer definitions
#define `$INSTANCE_NAME`_AUX_CTL_D_PTR	((reg8 *) `$INSTANCE_NAME`_datapath_u3__DP_AUX_CTL_REG)
#define `$INSTANCE_NAME`_AUX_CTL_D_REG	(*(reg8 *) `$INSTANCE_NAME`_datapath_u3__DP_AUX_CTL_REG)
