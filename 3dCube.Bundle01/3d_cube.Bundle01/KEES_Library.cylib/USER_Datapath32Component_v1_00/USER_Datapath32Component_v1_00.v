...
// Generated on 02/01/2013 at 16:08
// Component: USER_Datapath32Component_v1_00
module USER_Datapath32Component_v1_00 (
	output  State_0,
	output  State_1,
	output  State_2,
	input   Clock,
	...
	parameter A0_init_c = 0;
	parameter A0_init_d = 0;
	parameter A1_init_a = 0;
	parameter A1_init_b = 0;
	parameter A1_init_c = 0;
	parameter A1_init_d = 0;
	parameter D0_init_a = 0;
	parameter D0_init_b = 0;
	parameter D0_init_c = 0;
	parameter D0_init_d = 0;
	parameter D1_init_a = 0;
	parameter D1_init_b = 0;
	parameter D1_init_c = 0;
	parameter D1_init_d = 0;
...
cy_psoc3_dp32 #(.a0_init_a(A0_init_a), .a1_init_a(A1_init_a), .d0_init_a(D0_init_a), 
.d1_init_a(D1_init_a), .a0_init_b(A0_init_b), .a1_init_b(A1_init_b), 
.d0_init_b(D0_init_b), .d1_init_b(D1_init_b), .a0_init_c(A0_init_c), 
.a1_init_c(A1_init_c), .d0_init_c(D0_init_c), .d1_init_c(D1_init_c), 
.a0_init_d(A0_init_d), .a1_init_d(A1_init_d), .d0_init_d(D0_init_d), 
.d1_init_d(D1_init_d), 
.cy_dpconfig_a(
{
...
), .cy_dpconfig_b(
{
    ...
    `SC_A_MASK_DSBL, `SC_DEF_SI_0, `SC_SI_B_CHAIN,
    `SC_SI_A_CHAIN, /*CFG13-12: Shift A = LS, Shift B = Arith RS*/
    `SC_A0_SRC_ACC, `SC_SHIFT_SL, 1'h0,
    1'h0, `SC_FIFO1_BUS, `SC_FIFO0_BUS,
    `SC_MSB_DSBL, `SC_MSB_BIT0, `SC_MSB_CHNED,
