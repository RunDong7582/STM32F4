...
module CJCU_B_Isqrt32_v1_0 (
	...
	begin
		case (state)
			...
			B_SQRT_STATE_2: state <= (cl1[3] ? B_SQRT_STATE_8 : B_SQRT_STATE_3);
			...
			B_SQRT_STATE_7: state <= (z0[3] ? B_SQRT_STATE_11 : B_SQRT_STATE_1);
...
cy_psoc3_dp32 #(.d0_init_a(8'h00), .d1_init_a(8'h00), .d0_init_b(8'h00), 
