...
namespace CharLCDmp_v1_00
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCDmp_v1_00.CyCustomCharacter selectedCharacter = (CharLCDmp_v1_00.CyCustomCharacter)sender;
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_00.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_00.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_00.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
