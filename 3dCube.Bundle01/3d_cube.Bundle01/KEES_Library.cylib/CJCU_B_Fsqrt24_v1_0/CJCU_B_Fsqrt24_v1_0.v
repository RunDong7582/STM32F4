...
module CJCU_B_Fsqrt24_v1_0 (
	...
	begin
		case (state)
			...
			B_SQRT_STATE_2: state <= (cl1[2] && !sol_msb_reg[2] ? B_SQRT_STATE_8 : B_SQRT_STATE_3);
			B_SQRT_STATE_3: state <= B_SQRT_STATE_4;
			B_SQRT_STATE_4: state <= B_SQRT_STATE_5;
			B_SQRT_STATE_5: state <= (ce1[2] ? B_SQRT_STATE_11 : B_SQRT_STATE_6);
            ...
            B_SQRT_STATE_13: state <= (cl1[2] && !sol_msb_reg[2] ? B_SQRT_STATE_15 : B_SQRT_STATE_14);
...
cy_psoc3_dp24 #(.d0_init_a(8'h00), .d1_init_a(8'h01), .d0_init_b(8'h00), 
...
,`SC_FIFO__SYNC,`SC_EXTCRC_DSBL,`SC_WRK16CAT_DSBL}
        ...
        /*  output  [02:00]                  */  .co_msb(),
        /*  output  [02:00]                  */  .cmsb(),
        /*  output  [02:00]                  */  .so_reg(sol_msb_reg),
