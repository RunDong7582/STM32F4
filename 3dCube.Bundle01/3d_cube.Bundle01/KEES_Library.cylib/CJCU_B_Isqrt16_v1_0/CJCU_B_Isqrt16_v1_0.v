...
module CJCU_B_Isqrt16_v1_0 (
	...
	begin
		case (state)
			...
			B_SQRT_STATE_2: state <= (cl1[1] ? B_SQRT_STATE_8 : B_SQRT_STATE_3);
			...
			B_SQRT_STATE_7: state <= (z0[1] ? B_SQRT_STATE_11 : B_SQRT_STATE_1);
...
cy_psoc3_dp16 #(.d0_init_a(8'h00), .d1_init_a(8'h00), .d0_init_b(8'h40), 
.d1_init_b(8'h00), 
.cy_dpconfig_a(
{
