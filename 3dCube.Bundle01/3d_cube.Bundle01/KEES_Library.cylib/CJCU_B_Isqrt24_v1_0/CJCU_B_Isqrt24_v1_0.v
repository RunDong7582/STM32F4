...
module CJCU_B_Isqrt24_v1_0 (
	...
	localparam B_SQRT_STATE_1	 	= 4'b0001;	// 0th Op1 (f0_load, f1_load)
	localparam B_SQRT_STATE_2 		= 4'b0010;	// 0th Op2
	localparam B_SQRT_STATE_3 		= 4'b0011;	// 0th Op3 (f1_load)
	localparam B_SQRT_STATE_4	 	= 4'b0100;	// 0th Op4 (f0_load)
	localparam B_SQRT_STATE_5 		= 4'b0101;	// 0th Op5
	localparam B_SQRT_STATE_6	 	= 4'b0110;	// 0th Op6
	localparam B_SQRT_STATE_7	 	= 4'b1110;	// 1st Op6
	localparam B_SQRT_STATE_8	 	= 4'b1101;	// 1st Op5
	localparam B_SQRT_STATE_9		= 4'b0111;	// 0th Op7 (f1_load)
	localparam B_SQRT_STATE_10	 	= 4'b1100;	// 1st Op4
	localparam B_SQRT_STATE_11	 	= 4'b1111;	// 1st Op7 (f1_load)
	localparam B_SQRT_STATE_12	 	= 4'b1000;	// 1st Op0

	reg [3:0] state;
	
	wire f0_load = (state == B_SQRT_STATE_1 ||
					state == B_SQRT_STATE_4);
					
	wire f1_load = (state == B_SQRT_STATE_1 ||
					state == B_SQRT_STATE_3 ||
					state == B_SQRT_STATE_9 ||
					state == B_SQRT_STATE_11);
								
	wire fifo_dyn = (state == B_SQRT_STATE_0 ||
					 state == B_SQRT_STATE_12);

	assign eoc = (state == B_SQRT_STATE_12);
					
	wire [2:0] cs_addr = state[2:0];
	wire [2:0] z0;
	wire [2:0] cl1;
	...
	begin
		case (state)
			...
			B_SQRT_STATE_2: state <= (cl1[2] ? B_SQRT_STATE_8 : B_SQRT_STATE_3);
			B_SQRT_STATE_3: state <= B_SQRT_STATE_4;
			B_SQRT_STATE_4: state <= B_SQRT_STATE_5;
			B_SQRT_STATE_5: state <= B_SQRT_STATE_6;
			B_SQRT_STATE_6: state <= B_SQRT_STATE_7;
			B_SQRT_STATE_7: state <= (z0[2] ? B_SQRT_STATE_11 : B_SQRT_STATE_1);
			B_SQRT_STATE_8: state <= B_SQRT_STATE_9;
			B_SQRT_STATE_9: state <= B_SQRT_STATE_10;
			B_SQRT_STATE_10: state <= B_SQRT_STATE_7;
			B_SQRT_STATE_11: state <= B_SQRT_STATE_12;
			B_SQRT_STATE_12: state <= B_SQRT_STATE_0;
...
cy_psoc3_dp24 #(.d0_init_a(8'h00), .d1_init_a(8'h00), .d0_init_b(8'h00), 
.d1_init_b(8'h00), .d0_init_c(8'h40), .d1_init_c(8'h00), 
...
.cy_dpconfig_a(
{
    ...
    `CS_CMP_SEL_CFGA, /*CFGRAM0:      A0 = D0; A1 = D1*/
    ...
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM3:      A0 = F0; A1 = F1*/
    `CS_ALU_OP_PASS, `CS_SRCA_A1, `CS_SRCB_D0,
    `CS_SHFT_OP___SR, `CS_A0_SRC_NONE, `CS_A1_SRC__ALU,
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM4:      A1 = A1>>1*/
    `CS_ALU_OP__ADD, `CS_SRCA_A0, `CS_SRCB_A1,
    `CS_SHFT_OP_PASS, `CS_A0_SRC___F0, `CS_A1_SRC__ALU,
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM5:      A1 = A0 + A1; A0 = F0*/
    `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
    `CS_SHFT_OP___SR, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM6:      A0 = A0 >> 1*/
    `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
    `CS_SHFT_OP___SR, `CS_A0_SRC__ALU, `CS_A1_SRC___F1,
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM7:      A0 = A0 >> 1, A1 = F1*/
    8'hFF, 8'h00,  /*CFG9:            */
...
), .cy_dpconfig_b(
{
    ...
    8'hFF, 8'h00,  /*CFG9:            */
    8'hFF, 8'hFF,  /*CFG11-10:            */
    `SC_CMPB_A1_A0, `SC_CMPA_A1_A0, `SC_CI_B_CHAIN,
