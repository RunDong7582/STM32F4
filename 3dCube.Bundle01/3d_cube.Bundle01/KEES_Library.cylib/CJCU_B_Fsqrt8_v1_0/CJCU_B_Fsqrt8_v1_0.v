...
module CJCU_B_Fsqrt8_v1_0 (
	...
	begin
		case (state)
			...
			B_SQRT_STATE_2: state <= (cl1 && !sol_msb_reg ? B_SQRT_STATE_8 : B_SQRT_STATE_3);
			B_SQRT_STATE_3: state <= B_SQRT_STATE_4;
			B_SQRT_STATE_4: state <= B_SQRT_STATE_5;
			B_SQRT_STATE_5: state <= (ce1 ? B_SQRT_STATE_11 : B_SQRT_STATE_6);
            ...
            B_SQRT_STATE_13: state <= (cl1 && !sol_msb_reg ? B_SQRT_STATE_15 : B_SQRT_STATE_14);
...
cy_psoc3_dp8 #(.d0_init_a(8'h40), .d1_init_a(8'h01), 
.cy_dpconfig_a(
{
